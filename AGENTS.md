...
This file is the quick-reference operating contract for sys-locale-kotlin. The longer
...
sys-locale-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`sys-locale`](https://crates.io/crates/sys-locale). Upstream Rust is the behavioral oracle while the
