...
kotlin {
    ...
    val xcf = XCFramework("SysLocale")

    macosArm64 {
        binaries.framework { baseName = "SysLocale"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "SysLocale"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "SysLocale"
        flattenPackage = "io.github.kotlinmania.syslocale"
    }

    android {
        namespace = "io.github.kotlinmania.syslocale"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "sys-locale-kotlin", version.toString())

    pom {
        name.set("sys-locale-kotlin")
        description.set("Kotlin Multiplatform port of 1Password/sys-locale - Small and lightweight library to obtain the active system locale")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/sys-locale-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/sys-locale-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/sys-locale-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/sys-locale-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSysLocaleXCFramework",
    "assembleSysLocaleDebugXCFramework",
    "assembleSysLocaleReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSysLocaleXCFramework",
    "assembleReleaseIosFatFrameworkForSysLocaleXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSysLocaleXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSysLocaleXCFramework",
    "assembleDebugMacosFatFrameworkForSysLocaleXCFramework",
    "assembleReleaseMacosFatFrameworkForSysLocaleXCFramework",
    "assembleDebugTvosFatFrameworkForSysLocaleXCFramework",
    "assembleReleaseTvosFatFrameworkForSysLocaleXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSysLocaleXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSysLocaleXCFramework",
    "assembleDebugWatchosFatFrameworkForSysLocaleXCFramework",
    "assembleReleaseWatchosFatFrameworkForSysLocaleXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSysLocaleXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSysLocaleXCFramework",
